...
const styles = StyleSheet.create({
  ...
  username: { ...typography.title, color: colors.text, textAlign: 'center', marginTop: spacing.sm },
  meta: { ...typography.bodySmall, color: colors.textTertiary, textAlign: 'center', marginBottom: spacing.lg },
  socialRow: { flexDirection: 'row', marginBottom: spacing.lg, paddingHorizontal: spacing.sm },
  stats: { flexDirection: 'row', marginBottom: spacing.md },
  label: { ...typography.label, color: colors.textSecondary, marginTop: spacing.lg, marginBottom: spacing.xs },
  input: { backgroundColor: colors.surface, borderRadius: 12, padding: spacing.md, color: colors.text, marginBottom: spacing.md, minHeight: 80, borderWidth: 1, borderColor: colors.border, fontSize: 16 },
